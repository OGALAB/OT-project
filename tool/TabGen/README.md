...
> Adobe Experience Manager（AEM）におけるカレンダー更新作業の工数削減、ヒューマンエラーの防止を目的とした業務改善ツールです。当初はVanilla JSで構築しましたが、運用のしやすさとコードの保守性を高める為に、React及びTypeScriptへのリファクタリングを行いました。

## デモサイトについて
本ツールは本来、AEMの編集画面上に直接埋め込まれて動作する拡張機能です。
このデモサイトでは、環境構築無しでツールの入力/自動生成機能をすぐにお試しいただけるよう、Webサイト単体で動作する体験版として公開しています。
**[デモサイト](https://ot-project-mj5f.vercel.app/)**
